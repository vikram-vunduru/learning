...
export const APP_BUILDER_RESOURCES: Record<string, Resource[]> = {
  ...
  "app-builder-overview": [
    ...
    { type: "trailhead", title: "Platform Developer I — Platform Basics Module", url: "https://trailhead.salesforce.com/content/learn/modules/platform_dev1_platform_basics", description: "Solid intro to what the Salesforce platform is and how declarative tools fit in — essential orientation for students", duration: "~1 hr", level: "Beginner" },
  ...
  "app-builder-l01": [
    { type: "trailhead", title: "Platform Developer I — Platform Basics", url: "https://trailhead.salesforce.com/content/learn/modules/platform_dev1_platform_basics", description: "Covers the Force.com platform model, metadata-driven architecture, and where declarative fits vs code — perfect pre-read for this lecture", duration: "~1 hr", level: "Beginner" },
    ...
    { type: "blog", title: "Salesforce Platform App Builder Exam Guide — Salesforce Ben", url: "https://www.salesforceben.com/salesforce-platform-app-builder-exam-guide/", description: "Third-party breakdown of all exam topics — read the Platform Basics section to see what students need to retain", level: "Beginner" },
  ],

  // ── L02: Declarative vs Programmatic Development ─────────────────────────
  "app-builder-l02": [
    { type: "trailhead", title: "Platform Developer I — Platform Basics", url: "https://trailhead.salesforce.com/content/learn/modules/platform_dev1_platform_basics", description: "Explains the declarative / programmatic distinction with platform-native examples — foundational framing for the whole course", duration: "~1 hr", level: "Beginner" },
    ...
    { type: "trailhead", title: "Application Lifecycle and Development Models", url: "https://trailhead.salesforce.com/content/learn/modules/application_lifecycle_and_development_models", description: "Covers the development lifecycle and the difference between no-code, low-code, and pro-code approaches", duration: "~1.5 hr", level: "Beginner" },
  ...
  "app-builder-l03": [
    ...
    { type: "blog", title: "Salesforce Platform App Builder Exam Guide — Salesforce Ben", url: "https://www.salesforceben.com/salesforce-platform-app-builder-exam-guide/", description: "Security model is ~20% of the exam — study the exam guide section on this topic to calibrate depth", level: "Beginner" },
  ],

  // ── L04: Environment Strategy & Sandboxes ────────────────────────────────
  "app-builder-l04": [
    { type: "trailhead", title: "Application Lifecycle and Development Models", url: "https://trailhead.salesforce.com/content/learn/modules/application_lifecycle_and_development_models", description: "Covers all sandbox types, org strategy, and release management best practices — mandatory prep for this lecture", duration: "~1.5 hr", level: "Beginner" },
  ...
  "app-builder-l07": [
    ...
    { type: "blog", title: "Salesforce Platform App Builder Exam Guide — Salesforce Ben", url: "https://www.salesforceben.com/salesforce-platform-app-builder-exam-guide/", description: "The data modeling section in this guide shows exactly which relationship behaviors the exam tests", level: "Beginner" },
  ],
  ...
  "app-builder-l10": [
    ...
    { type: "blog", title: "Salesforce Platform App Builder Exam Guide — Salesforce Ben", url: "https://www.salesforceben.com/salesforce-platform-app-builder-exam-guide/", description: "Review the automation section — validation rules are a frequent exam topic alongside flow and approval processes", level: "Beginner" },
  ],
  ...
  "app-builder-l11": [
    ...
    { type: "trailhead", title: "Flow Builder — Trailhead Module", url: "https://trailhead.salesforce.com/content/learn/modules/flow-builder", description: "Dedicated Flow Builder module — start here before teaching any flow lecture. Covers all flow types and elements.", duration: "~2 hr", level: "Beginner" },
  ...
  // ── L12: Screen Flows ─────────────────────────────────────────────────────
  "app-builder-l12": [
    { type: "trailhead", title: "Flow Builder — Trailhead Module", url: "https://trailhead.salesforce.com/content/learn/modules/flow-builder", description: "Screen flow creation is covered in depth here — complete the module before recording to validate your demo steps", duration: "~2 hr", level: "Beginner" },
  ...
  "app-builder-l13": [
    { type: "trailhead", title: "Flow Builder — Trailhead Module", url: "https://trailhead.salesforce.com/content/learn/modules/flow-builder", description: "Record-triggered flows are the most exam-tested flow type — this module covers before-save vs after-save triggers in detail", duration: "~2 hr", level: "Beginner" },
  ...
  "app-builder-l14": [
    { type: "trailhead", title: "Flow Builder — Trailhead Module", url: "https://trailhead.salesforce.com/content/learn/modules/flow-builder", description: "Covers scheduled flows and autolaunched flows — including invocable actions and subflow patterns", duration: "~2 hr", level: "Intermediate" },
    ...
    { type: "blog", title: "Salesforce Platform App Builder Exam Guide — Salesforce Ben", url: "https://www.salesforceben.com/salesforce-platform-app-builder-exam-guide/", description: "Review the automation comparison table in this guide — flow type selection is a frequent exam scenario question", level: "Intermediate" },
  ],
  ...
  "app-builder-l18": [
    ...
    { type: "blog", title: "Salesforce Platform App Builder Exam Guide — Salesforce Ben", url: "https://www.salesforceben.com/salesforce-platform-app-builder-exam-guide/", description: "UI section of this guide covers app navigation questions that appear on the exam", level: "Beginner" },
  ],
  ...
  "app-builder-l19": [
    ...
    { type: "trailhead", title: "Platform Developer I — Platform Basics", url: "https://trailhead.salesforce.com/content/learn/modules/platform_dev1_platform_basics", description: "Platform Basics contextualizes report types and data access within the full platform architecture", duration: "~1 hr", level: "Beginner" },
  ...
  "app-builder-l21": [
    { type: "trailhead", title: "Application Lifecycle and Development Models", url: "https://trailhead.salesforce.com/content/learn/modules/application_lifecycle_and_development_models", description: "Change sets, sandboxes, and release management — this module is the primary source for the App Deployment exam section", duration: "~1.5 hr", level: "Beginner" },
  ...
  "app-builder-l22": [
    ...
    { type: "trailhead", title: "Application Lifecycle and Development Models", url: "https://trailhead.salesforce.com/content/learn/modules/application_lifecycle_and_development_models", description: "Covers AppExchange packages within the application lifecycle context — app distribution is a deployment model topic", duration: "~1.5 hr", level: "Beginner" },
    ...
    { type: "blog", title: "Salesforce Platform App Builder Exam Guide — Salesforce Ben", url: "https://www.salesforceben.com/salesforce-platform-app-builder-exam-guide/", description: "The deployment section of this guide covers AppExchange package types that appear on the exam", level: "Intermediate" },
  ],
  ...
  "app-builder-l23": [
    ...
    { type: "trailhead", title: "Application Lifecycle and Development Models", url: "https://trailhead.salesforce.com/content/learn/modules/application_lifecycle_and_development_models", description: "Package types and their role in the development lifecycle — covers the full spectrum from change sets to managed packages", duration: "~1.5 hr", level: "Intermediate" },
    ...
    { type: "blog", title: "Salesforce Platform App Builder Exam Guide — Salesforce Ben", url: "https://www.salesforceben.com/salesforce-platform-app-builder-exam-guide/", description: "Package type comparison table in this guide directly mirrors how the exam frames deployment scenario questions", level: "Intermediate" },
  ],

  // ── Lab 01: Developer Org Setup & Navigation ──────────────────────────────
  "app-builder-lab01": [
    { type: "trailhead", title: "Platform Developer I — Platform Basics", url: "https://trailhead.salesforce.com/content/learn/modules/platform_dev1_platform_basics", description: "Teaches Setup navigation, object manager, and Salesforce UI basics — all students need this before Lab 1", duration: "~1 hr", level: "Beginner" },
  ...
  "app-builder-lab03": [
    { type: "trailhead", title: "Flow Builder — Trailhead Module", url: "https://trailhead.salesforce.com/content/learn/modules/flow-builder", description: "Complete this before supervising Lab 3 — the module's hands-on challenges are close to what students build in the lab", duration: "~2 hr", level: "Beginner" },
  ...
  "app-builder-exam": [
    ...
    { type: "blog", title: "Salesforce Platform App Builder Exam Guide — Salesforce Ben", url: "https://www.salesforceben.com/salesforce-platform-app-builder-exam-guide/", description: "The most popular free study guide — topic-by-topic breakdown with exam tips. Compare against your course coverage.", level: "Beginner" },
  ...
  "app-builder-cheatsheet": [
    ...
    { type: "blog", title: "Salesforce Platform App Builder Exam Guide — Salesforce Ben", url: "https://www.salesforceben.com/salesforce-platform-app-builder-exam-guide/", description: "Cross-reference this guide against your cheat sheet — Salesforce Ben's topic breakdown mirrors the official exam objectives", level: "Beginner" },
