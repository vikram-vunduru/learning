...
export const DATA_CLOUD_RESOURCES: Record<string, Resource[]> = {
  "dc-overview": [
    ...
    { type: "trailhead", title: "Salesforce Data Cloud Basics — Trailhead", url: "https://trailhead.salesforce.com/content/learn/modules/salesforce-data-cloud-basics", description: "Start here — official Trailhead intro to Data Cloud concepts", duration: "~1.5 hr", level: "Beginner" },
    { type: "docs", title: "Data Cloud Developer Guide", url: "https://developer.salesforce.com/docs/data/data-cloud/guide/index.html", description: "Primary technical reference for all Data Cloud APIs and configuration", level: "Intermediate" },
  ...
  "dc-l01": [
    { type: "docs", title: "Data Cloud Architecture Guide", url: "https://developer.salesforce.com/docs/data/data-cloud/guide/index.html", description: "Official architecture documentation — DLO, DMO, Unified Individual", level: "Intermediate" },
    { type: "trailhead", title: "Salesforce Data Cloud Basics", url: "https://trailhead.salesforce.com/content/learn/modules/salesforce-data-cloud-basics", description: "Foundational module covering the Data Cloud platform architecture", duration: "~1.5 hr", level: "Beginner" },
  ...
  "dc-l02": [
    ...
    { type: "docs", title: "Ingestion API Reference", url: "https://developer.salesforce.com/docs/data/data-cloud/guide/index.html", description: "Ingestion API authentication, payload format, and batch vs streaming modes", level: "Advanced" },
    { type: "youtube", title: "Data Cloud Ingestion — Salesforce Developers", url: "https://www.youtube.com/@SalesforceDevelopers", description: "Search 'Data Cloud data ingestion' for connector setup walkthroughs", duration: "25 min" },
  ],
  "dc-l03": [
    ...
    { type: "docs", title: "Data Cloud Standard Data Model", url: "https://developer.salesforce.com/docs/data/data-cloud/guide/index.html", description: "Standard DMO schema reference — Individual, Contact Point, Engagement", level: "Advanced" },
  ],
  "dc-l04": [
  ...
  "dc-l05": [
    ...
    { type: "youtube", title: "Data Cloud Segmentation — Salesforce Developers", url: "https://www.youtube.com/@SalesforceDevelopers", description: "Search 'Data Cloud segmentation' for segment builder walkthroughs", duration: "20 min" },
  ],
  "dc-l06": [
    ...
    { type: "youtube", title: "Calculated Insights Tutorial — Salesforce", url: "https://www.youtube.com/@SalesforceDevelopers", description: "Search 'Data Cloud calculated insights SQL' for hands-on demos", duration: "25 min" },
  ],
  "dc-l07": [
  ...
  "dc-l08": [
    ...
    { type: "blog", title: "GDPR & Salesforce Data Cloud", url: "https://www.salesforce.com/company/responsible-ai-policy/", description: "Salesforce's privacy and data responsibility framework", level: "Intermediate" },
  ],
  "dc-l09": [
  ...
  "dc-l12": [
    { type: "docs", title: "Agentforce Grounding with Data Cloud", url: "https://developer.salesforce.com/docs/einstein/genai/guide/agentforce-grounding.html", description: "How Agentforce uses Data Cloud vector search for RAG grounding", level: "Advanced" },
    { type: "docs", title: "Einstein Vector Search — Developer Guide", url: "https://developer.salesforce.com/docs/einstein/genai/guide/vector-search.html", description: "Vector database in Data Cloud for semantic AI search", level: "Advanced" },
  ],
  "dc-l13": [
  ...
  "dc-exam": [
    ...
    { type: "trailhead", title: "Prepare for Data Cloud Consultant — Trail Mix", url: "https://trailhead.salesforce.com/users/strailhead/trailmixes/prepare-for-your-salesforce-data-cloud-consultant-credential", description: "Official Salesforce recommended study path", duration: "~10 hr", level: "Intermediate" },
  ...
  "dc-cheatsheet": [
    ...
    { type: "docs", title: "Data Cloud Developer Guide", url: "https://developer.salesforce.com/docs/data/data-cloud/guide/index.html", description: "Quick reference for any technical term in the cheat sheet", level: "Intermediate" },
  ],
};
