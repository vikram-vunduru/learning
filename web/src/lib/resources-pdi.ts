...
export const PDI_RESOURCES: Record<string, Resource[]> = {
  ...
  "pdi-overview": [
    ...
    { type: "blog", title: "PDI Exam Guide — Salesforce Ben", url: "https://www.salesforceben.com/", description: "The most widely-read third-party PDI guide — topic-by-topic breakdown with pass-rate tips and recommended resources.", level: "Beginner" },
  ...
  "pdi-l01": [
    { type: "trailhead", title: "Apex Basics & Database — Get Started with Apex", url: "https://trailhead.salesforce.com/content/learn/modules/apex_database", description: "The official starting point for Apex on Trailhead — covers Developer Console basics, Anonymous Apex, and the execute window.", duration: "~1 hr", level: "Beginner" },
  ...
  "pdi-l09": [
    ...
    { type: "blog", title: "Apex Trigger Best Practices — Salesforce Ben", url: "https://www.salesforceben.com/", description: "Salesforce Ben's practical trigger best practices article — handler class pattern, recursion prevention, and bulkification all explained. Use examples as lecture talking points.", level: "Intermediate" },
  ...
  // ── L22: Debugging ────────────────────────────────────────────────────────
  "pdi-l22": [
    { type: "trailhead", title: "Apex Debugging and Testing — Trailhead Module", url: "https://trailhead.salesforce.com/content/learn/modules/apex_testing", description: "Covers Developer Console log inspector, debug log levels, checkpoints, and heap dump analysis. Complete before recording L22.", duration: "~2 hr", level: "Intermediate" },
  ...
  // ── L23: Deployment ───────────────────────────────────────────────────────
  "pdi-l23": [
    { type: "trailhead", title: "Application Lifecycle and Development Models — Trailhead", url: "https://trailhead.salesforce.com/credentials/platformdeveloperi", description: "PRIMARY MODULE — covers change sets, SFDX source format, scratch orgs, and sandbox strategies. Complete before recording L23.", duration: "~2 hr", level: "Intermediate" },
  ...
  "pdi-l24": [
    { type: "trailhead", title: "Secure Coding — Injection Vulnerabilities (Trailhead)", url: "https://developer.salesforce.com/docs/atlas.en-us.secure_coding_guide.meta/secure_coding_guide/secure_coding_apex_enforcing_crud_flsd.htm", description: "PRIMARY MODULE — covers SOQL injection, String.escapeSingleQuotes(), and dynamic SOQL risks. PDI exam tests this heavily — do all units before recording.", duration: "~2 hr", level: "Intermediate" },
  ...
  "pdi-lab01": [
    { type: "trailhead", title: "Apex Basics & Database — Setup and Anonymous Apex", url: "https://trailhead.salesforce.com/content/learn/modules/apex_database", description: "The starting Trailhead module used for Lab 01 setup — walks through org setup, Developer Console, and first Apex execution.", duration: "~1 hr", level: "Beginner" },
  ...
  "pdi-exam": [
    ...
    { type: "blog", title: "Salesforce Ben — PDI Exam Guide", url: "https://www.salesforceben.com/", description: "Salesforce Ben's comprehensive free PDI exam guide — covers all topic areas with study recommendations and exam-day tips.", level: "Intermediate" },
  ],
  ...
  "pdi-cheatsheet": [
    ...
    { type: "blog", title: "Salesforce Ben — PDI Quick Reference", url: "https://www.salesforceben.com/", description: "Salesforce Ben's guide has a concise summary of each topic area — cross-reference against your cheat sheet for completeness.", level: "Intermediate" },
  ],
