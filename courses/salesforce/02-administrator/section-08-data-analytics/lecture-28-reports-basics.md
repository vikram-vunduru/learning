...
**Visual:** Screenshot of the Report Builder interface with labeled components (Fields panel, Filters panel, Preview panel, toolbar)
**Content:**
...
**Visual:** Annotated screenshot with four quadrants: (1) Fields panel left side, (2) Report canvas center, (3) Outline and Filters tabs, (4) Preview at bottom
**Content:**
...
**Visual:** Table showing a simple flat list of Opportunity Name | Close Date | Amount with no subtotals
**Content:**
...
**Visual:** Side-by-side comparison — Summary shows Opportunity owner with subtotal rows; Matrix shows a pivot table with Stage across columns and Owner down rows
**Content:**
...
**Visual:** Diagram showing two side-by-side blocks (Report Type A: Opportunities | Report Type B: Cases) combined in one view with separate column sets
**Content:**
...
**Visual:** Report showing a grouping row "Stage = Closed Won" with subtotal row showing SUM: $450,000 | AVG: $45,000 | MIN: $5,000 | MAX: $120,000
**Content:**
...
**Visual:** Filters panel screenshot showing three sections: Standard Filters (Show Me, Date Field, Range), Field Filters (custom field conditions), Row Limit option
**Content:**
...
**Visual:** Diagram showing Report Folders → Sharing (Public/Private/Shared with roles/groups), plus a clock icon for "Schedule Report" and a user icon for "Running User"
**Content:**
